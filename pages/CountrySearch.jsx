  ...
  return (
    ...
    <div className='w-screen h-[50vh] relative'>
      ...
      <div className='absolute top-[70%] max-w-[1240px] w-full left-[50%] right-[50%] translate-x-[-50%] translate-y-[-50%] text-white z-10 p-2'>
        <h2 className='py-2'>My CountrySearch</h2>
    ...
    <div className='max-w-[1240px] mx-auto p-2 grid md:grid-cols-5 gap-8 py-8'>
      <div className='col-span-4'>
        ...
        <p>
          ...
          The app is built to know the countries in the world and their
          borders.
        </p>
        <a
          href='https://github.com/Adedeji08/rest-countries-api-with-color-theme-switcher-master-main'
          target='_blank'
          rel='noreferrer'
        >
        ...
        <a
          href='https://flagcountries.netlify.app/'
          target='_blank'
          rel='noreferrer'
        >
